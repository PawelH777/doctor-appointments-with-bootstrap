...
describe('<FormInput />', () => {
    it('should render input without errors', () => {
        ...
        // when
        const wrapper = shallow(<FormInput label={nameLabel} attributes={nameAttributes} errors={[]}/>);
    ...
    it('should render textarea without errors', () => {
        ...
        // when
        const wrapper = shallow(<FormInput label={contentLabel} attributes={contentAttributes} errors={[]}/>);
    ...
    it('should render input with errors', () => {
        ...
        const numberErrors = [numberRules.isNumber.errorMessage, numberRules.maxLength.errorMessage, numberRules.minLength.errorMessage,
            numberRules.required.errorMessage];

        // when
        const wrapper = shallow(<FormInput label={numberLabel} attributes={numberAttributes} errors={numberErrors}/>);
