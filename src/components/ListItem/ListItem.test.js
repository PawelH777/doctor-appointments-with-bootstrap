...
describe('<ListItem />', () => {
    it('should render list item with passing correct values', () => {
        ...
        // when
        const wrapper = shallow(<ListItemCustom paperCss={expectedPaperCssProp} isButton={expectedIsButtonProp}
                                                isDisabled={expectedIsDisabledProp}
                                                clicked={expectedOnClickProp} primary={expectedPrimaryProp}
