...
describe('<Appointment />', () => {
    it('should render appointment in edit mode', () => {
        // given
        const expectedCauses = ['test appointment cause', 'test appointment cause 2'];
        const expectedSelectedCause = 'test appointment cause';

        // when
        const wrapper = shallow(<Appointment editMode={true} appointmentCauses={expectedCauses}
    ...
    it('should render appointment in read mode', () => {
        ...
        // when
        const wrapper = shallow(<Appointment editMode={false} selectedAppointmentCause={expectedSelectedCause}/>);
